          ...
          <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="task_name" name="task_name" class="form-control" placeholder="请输入任务名称" required />
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="task_url" name="task_url" class="form-control" placeholder="请输入任务地址" required />
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-3 control-label">说明 <span class="asterisk">*</span></label>
                  <div class="col-sm-9">
                    <textarea id="task_summary" name="task_summary" rows="5" class="form-control" placeholder="请简要说明提测的注意事项" required></textarea>
                  </div>
                </div>
              </div><!-- panel-body -->
